...
export const FoodBridgeProvider = ({ children }) => {
  ...
  const addDonation = (newDonation) => {
    ...
    const donationRecord = {
      ...
      location: newDonation.location || currentUser.location || '14 Grand Boulevard, Central District',
      coords: [12.9716 + (Math.random() - 0.5) * 0.04, 77.5946 + (Math.random() - 0.5) * 0.04],
      distance: '1.2 km',
      status: 'Pending',
      ...
      destinationNgo: newDonation.destinationNgo || 'Helping Hands NGO',
      createdAt: timeStr,
